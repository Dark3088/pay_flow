...
class InvoiceListController {
  final invoiceValueNotifier =
      ValueNotifier<List<InvoiceModel>>(<InvoiceModel>[]);

  List<InvoiceModel> get invoiceModelList => invoiceValueNotifier.value;
  set invoiceModelList(List<InvoiceModel> value) =>
      invoiceValueNotifier.value = value;
  ...
  Future<void> getInvoices() async {
    try {
      ...
      invoiceModelList =
          invoiceList.map((e) => InvoiceModel.fromJson(e)).toList();
    } catch (e) {
